...
/**
 * A thin native wrapper that displays the sotaserver web UI in a WebView.
 *
 * The UI itself is served by the sotaserver binary's "serve" command, which
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Where the sotaserver server is listening. Change the port here if you
    ...
    private String notRunningHtml() {
        return "<!DOCTYPE html><html><head><meta name='viewport' "
                ...
                + "<body><h1>Can’t reach the sotaserver server</h1>"
                + "<p>Start it on this device (for example in Termux), then tap Retry:</p>"
                + "<pre>./sotaserver serve</pre>"
