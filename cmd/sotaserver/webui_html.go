...
<title>Sota's Pen Testing</title>
<style>
  :root {
...
<main>
  ...
  <section id="view-help" class="hidden">
    <div class="card">
      <h2>How to run</h2>
      <p class="desc">This page is served by the sotaserver binary. Pick a tool above, fill in the target, and tap Run.</p>
      ...
      <span class="cmd">go build -o sotaserver ./cmd/sotaserver</span>
      <span class="cmd">./sotaserver I need help</span>
      <span class="cmd">./sotaserver dns -domain example.com</span>
      <h3>Start this web app</h3>
      <span class="cmd">./sotaserver serve</span>
      <p class="desc">Then open <code>http://127.0.0.1:8787</code>. To use it from your phone on the
      same Wi-Fi, run <code>./sotaserver serve -addr 0.0.0.0:8787</code> and browse to your
