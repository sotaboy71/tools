...
// the user runs `sotaserver I need help`.
func runGuide(ctx context.Context, args []string) error {
	fmt.Print(guideText)
	return nil
}

const guideText = `Sota's Pen Testing — step-by-step guide
================================
